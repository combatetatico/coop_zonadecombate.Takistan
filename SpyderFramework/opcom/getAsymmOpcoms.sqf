/* ----------------------------------------------------------------------------
Function: SF_fnc_getAsymmOpcoms

Description:
Returns opcom handlers
...
Examples:
(begin example)
_opcoms = [] call SF_fnc_getAsymmOpcoms;
_opcoms = ["EAST"] call SF_fnc_getAsymmOpcoms;
_opcom = ["OPF_G_F"] call SF_fnc_getAsymmOpcoms; //-- Can also be done by simply doing: ["OPF_G_F"] call SF_fnc_getOpcom;
(end)
...
["SF_fnc_getAsymmOpcoms: Returning %1 asymmetric opcoms", count _asymmOpcoms] call ALIVE_fnc_dump;
